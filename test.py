...
# 10 iter
city, people, ans = test_case(10000) # suppose there are 10000 houses in town
for i in range(10):
...
print(f"Average difference between:{(res_sum - ans_sum) / 10}, while adjusted difference is: {(res2_sum - ans_sum) / 10}")